dependencies {
    testImplementation(project(":inditex-ms-app"))
    testImplementation(project(":inditex-ms-common"))
    testImplementation(project(":inditex-ms-client"))
    testImplementation(project(":inditex-ms-core"))
